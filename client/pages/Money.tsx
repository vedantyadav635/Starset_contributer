      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white/5 dark:bg-zinc-900/50 backdrop-blur-sm p-8 rounded-2xl border border-zinc-200 dark:border-white/10 hover:border-emerald-500/50 transition-colors group">
            ...
            <div className="bg-white/5 dark:bg-zinc-900/50 backdrop-blur-sm p-8 rounded-2xl border border-zinc-200 dark:border-white/10 hover:border-blue-500/50 transition-colors group">
            ...
            <div className="bg-white/5 dark:bg-zinc-900/50 backdrop-blur-sm p-8 rounded-2xl border border-zinc-200 dark:border-white/10 hover:border-purple-500/50 transition-colors group">
          ...
          <div className="bg-[#1c1917]/80 dark:bg-zinc-900/80 backdrop-blur-md rounded-3xl p-12 text-white relative overflow-hidden">
