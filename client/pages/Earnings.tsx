        ...
        <div className="lg:col-span-2 bg-white dark:bg-zinc-900 rounded-3xl border border-stone-200 dark:border-white/5 shadow-xl p-6 md:p-8 flex flex-col h-full relative overflow-hidden">
          ...
          <div className="space-y-4 flex-1 relative z-10">
            ...
            <button
              ...
              className="w-full border-2 border-dashed border-stone-200 dark:border-white/10 rounded-2xl p-4 flex items-center justify-center text-stone-500 hover:border-blue-600 dark:hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/10 transition-all font-bold mt-auto text-base h-16 group"
            >
              <div className="bg-stone-100 dark:bg-white/10 p-1 rounded-full mr-2 group-hover:bg-blue-600 group-hover:text-white transition-colors">
            ...
            <div className="p-8">
              ...
              <div className="flex p-1.5 bg-stone-100 dark:bg-black rounded-xl mb-8">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center py-2.5 text-sm font-bold rounded-lg transition-all ${addMethodTab === 'upi' ? 'bg-white dark:bg-zinc-800 text-blue-600 dark:text-white shadow-md transform scale-[1.02]' : 'text-stone-500 hover:text-stone-700'}`}
                >
                  <Smartphone className="h-4 w-4 mr-2" /> UPI
                </button>
                <button
                  onClick={() => setAddMethodTab('bank')}
                  className={`flex-1 flex items-center justify-center py-2.5 text-sm font-bold rounded-lg transition-all ${addMethodTab === 'bank' ? 'bg-white dark:bg-zinc-800 text-blue-600 dark:text-white shadow-md transform scale-[1.02]' : 'text-stone-500 hover:text-stone-700'}`}
                >
