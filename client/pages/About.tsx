         ...
         <section className="py-24 px-6 relative overflow-hidden">
            <div className="max-w-7xl mx-auto">
               ...
               <div className="grid lg:grid-cols-3 gap-8 mt-20">
                  <div className="bg-zinc-900/50 backdrop-blur-md p-10 rounded-[2rem] border border-white/10 relative group hover:-translate-y-2 transition-all duration-300">
                     ...
                     <h3 className="text-2xl font-bold text-white mb-3">We Connect You</h3>
                  ...
                  <div className="bg-zinc-900/50 backdrop-blur-md p-10 rounded-[2rem] border border-white/10 relative group hover:-translate-y-2 transition-all duration-300">
                     ...
                     <h3 className="text-2xl font-bold text-white mb-3">You Teach AI</h3>
                     <p className="text-zinc-400 leading-relaxed font-medium">
                  ...
                  <div className="bg-zinc-900/50 backdrop-blur-md p-10 rounded-[2rem] border border-white/10 relative group hover:-translate-y-2 transition-all duration-300">
                     ...
                     <h3 className="text-2xl font-bold text-white mb-3">Better Future</h3>
                     <p className="text-zinc-400 leading-relaxed font-medium">
               ...
               <div className="mt-24 bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-12 border border-white/5 shadow-inner">
